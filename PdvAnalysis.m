classdef PdvAnalysis < matlab.apps.AppBase
    %PDVANALYSIS  A GUI for analysing PDV data.
    %   For more information, see <a href="matlab:
    %   web('https://github.com/liamcsmith/PDVTool/blob/master/README.md')">GitHub</a>.
    ...
    properties (Access = public)
        ...
        Velocity                = []; % A struct containing output information if there is any.
    ...
    methods (Access = private)
        ...
        function PdvAnalysisStartup(app, inputargs)
            ...
            app.WindowSizesLabel.Text    = [DeltaPhiText,' Window Size (µs)'];
        ...
        function CheckDeltaPhiButtonPushed(app, event)
            ...
            if AWPExist && NonZeroWindow && SampleRegionExist && app.Baseline.BasicRemoval
                ...
                if PredDeltaPhi > (pi/2) || PredDeltaPhi < (pi/8)
                    ...
                    PlotTitle = [DeltaPhiText,' Across Window (Recommended Size: ',num2str(Fs*round(WindowSize * ((pi/4)/PredDeltaPhi))),' µs)'];
                else
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.WindowSizesLabel.Text = '∆Φ Window Size (µs)';
            ...
            app.CheckDeltaPhiButton.Text = 'Check ∆Φ Window';
            ...
            app.ApplyDeltaPhiButton.Text = 'Apply ∆Φ Correction';
            ...
            app.ZeroTimesLabel.Text = 'Zero Φ Time (µs)';
