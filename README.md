...
1) Edit the value for the property ScopeTracePath. To find this you can use the MATLAB documentation hyperlink or find %%ScopeTracePath%% in the PdvTrace.m file.
2) Edit the value for the property ScopeTracePath in PdvAnalysis.m. To find this you can use the MATLAB documentation hyperlink (in the PdvAnalysis documentation) or find %%ScopeTracePath%% in the PdvAnalysis.m file.
...
| MethodName 		| Input 			| Output 																					| Summary 														|
| ----------------- | ----------------- | ----------------------------------------------------------------------------------------- | ------------------------------------------------------------- |
...
To have PDVAnalysis work correctly you will need to:
 1) Edit the value for the property ScopeTracePath in PdvAnalysis.m. To find this you can use the MATLAB documentation hyperlink or find %%ScopeTracePath%% in the PdvAnalysis.m file.
